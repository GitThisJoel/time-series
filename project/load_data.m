function [modeling_set, validation_set, test_set, index_validation, index_test] = load_data(raw_data, start, l_modelling, l_test)
    ...
    index_test = [ round(start + length(raw_data) * 0.47) round(start + length(raw_data) * 0.47) + l_test];
end
